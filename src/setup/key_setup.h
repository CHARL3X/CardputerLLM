// Adapted from CardputerLLM/src/setup/key_setup.h. No interface changes;
// save path references /Cardputer/openrouter.txt via sd_config.
#pragma once
#include <Arduino.h>
...
// (`sk-or-` prefix), saved to /Cardputer/openrouter.txt, the server stops,
